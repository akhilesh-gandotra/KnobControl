...
s.homepage     = "http://google.com"
  ...
  s.author             = { "Akhilesh Gandotra" => "akhilesh.gandotra@htdigital.in" }
  # Or just: s.author    = "Akhilesh Gandotra"
  # s.authors            = { "Akhilesh Gandotra" => "akhilesh.gandotra@htdigital.in" }
  # s.social_media_url   = "http://twitter.com/Akhilesh Gandotra"
...
s.source       = { :git => "https://github.com/akhilesh-gandotra/KnobControl.git", :tag => "1.0.0" }
  # ――― Source Code ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
